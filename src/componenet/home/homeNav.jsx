...
function IndexNavbar() {
  ...
  function MyModel(){
    return(
      <div className='fixed inset-0 bg-black'>mymodel </div>
    )
  }
  return (
    <>
      <div className='bg-black dark:bg-gray-900  fixed h-10 w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600 flex justify-end items-center '>
    ...
    <nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-10 start-0 border-b border-gray-200 dark:border-gray-600">
      ...
      <div className="flex md:order-2 space-x-3 md:space-x-3 rtl:space-x-reverse">
          ...
          <button type="button" onClick={()=>navigate('/signup/up')} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-3xl text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sign Up Free</button>
